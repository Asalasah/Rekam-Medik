...
?>
		<head>
			<title>Selamat datang di Rumah Sakit INF <?php echo $username; ?></title>
			<LINK rel="stylesheet" TYPE="text/css" href="css.css">
			<!--link href='http://fonts.googleapis.com/css?family=Open+Sans:700italic,400' rel='stylesheet' type='text/css'/-->
			<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		</head>
		<div id='kepala'>
			<div id='salam' align='center'>Masukkan nomor Id dan Kode XXX untuk login</div>
		</div> 
...
<body>		
		<div id='badan'>
			<div id='wrapper' style='width:700px'>
				...
				<div id='fotologin'> 
                    	<img src='/rekammedik/gambar/pasien.png'/>
					</div> 
					<div id='tempatlogin'>
                    	<center>
						<form action="prosesloginpasien.php" method="post">
						<table id='tabelx'>
							<tr><td>ID Pasien </td><td>: </td><td><input type="text" name="username" /></td></tr>
							<tr><td>Kode XXX </td><td>: </td><td><input type="password" name="password" /></td></tr>
